...
# load data
ps_data <- read.csv(
  file.path("C:/Users/sren/Dropbox (Partners HealthCare)/BOC shared/
  Chemo during pregnancy (Sella)/data", "ps_data.csv")
)
...
ATE_composite_MI <- lapply(
  imputed_data, # iterate over 10 imputed datasets
  function(d) {
    # taxane
