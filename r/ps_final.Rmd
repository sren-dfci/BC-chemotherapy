...
data_path <- "boc/chemotherapy/data"
code_path <- "boc/chemotherapy/r"
...
# load data
load(file.path(code_path, "RData", "ps_data.RData"))
...
tbl1_vars <- c("age_norm", "gadx_norm", "I_stage_34",
