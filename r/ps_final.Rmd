...
best_formula_taxol <- "taxolpreg ~ I_HER2 + gadx_norm + I_TNBC + I_stage_34 + I_surgery + I_neoadjuvant + yeardx_centered + neo_stage + surg_stage + gadx_surg + gadx_neo + tnbc_stage + tnbc_neo"

best_formula_gcsf <- "gfpreg ~ I_HER2 + gadx_norm + I_TNBC + I_stage_34 +
I_surgery + I_neoadjuvant + yeardx_centered + neo_stage + surg_neo + gadx_stage"
...
For taxane: I(taxane = 1) ~ I(type = HER2) + I(type = TNBC) + gestational age + I(stage = 3,4) + I(surgery = 1) + I(timing = neoadjuvant) + year of diganosis + I(timing = neoadjuvant) \* I(stage = 3,4) + I(surgery = 1) \* I(stage = 3,4) + gestational age \* I(surgery = 1) + gestational age \* I(timing = neoadjuvant) + I(type = TNBC) \* I(stage = 3,4) + I(type = TNBC) \* I(timing = neoadjuvant)

For CSF: I(CSF = 1) ~ I(type = HER2) + I(type = TNBC) + gestational age + I(stage = 3,4) + I(surgery = 1) + I(timing = neoadjuvant) + year of diagnosis + I(timing = neoadjuvant) \* I(stage = 3,4) + I(surgery = 1) \* I(timing = neoadjuvant) + gestational age \* I(stage = 3,4)
...
taxol_coefs$covariate <- c(
  ...
  "Neoadjuvant", "Year of diagnosis", "Neoadjuvant*Stage", "Surgery*Stage", 
  "Gestational age*Surgery", "Gestational age*Neoadjuvant", "TNBC*Stage", "TNBC*Neoadjuvant"
)
taxol_coefs %>%
  mutate(
    est.or = exp(Estimate),
...
gcsf_coefs$covariate <- c(
  "Intercept", "HER2", "Gestational age", "TNBC", "Stage", "Surgery",
  "Neoadjuvant", "Year of diagnosis", "Neoadjuvant*Stage", "Surgery*Neoadjuvant",
